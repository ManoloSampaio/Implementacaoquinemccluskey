...
- [X] Carlos Alfredo :Repassar o código de python para C. <br>
- [X] Emmanuel Sampaio :Desenvolver a interface que vai ser utilizada para mostrar o circuito simplificado e ajudar no app -<br>
- [X] Eduardo Serpa: Desenvolver a aplicação usando MIT App Inventor <br>
